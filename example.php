...
// define the helper
$opa = Loader::helper('on_page_attributes', 'adi_onpage_attributes');
...
echo Loader::helper('on_page_attributes', 'adi_onpage_attributes')->getAttributeForm($onPageAttributes,'Page Settings');
